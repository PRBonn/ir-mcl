...
def get_args():
    ...
    # data
    parser.add_argument('--bag_file', type=str, default='~/ir-mcl/data/intel/intel.bag',
                        help='the file path of rosbag')
    parser.add_argument('--output_json', type=str, default='~/ir-mcl/data/intel/intel.json',
...
if __name__ == '__main__':
    ...
    json_converter.convert_to_json_mapping(args.output_json)
